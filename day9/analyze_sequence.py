...
def analyze_sequence(file_path, find_duplicates=False, find_gc=False, find_motifs=False):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Analyze sequences in FASTA format.")
    ...
    parser.add_argument("--GCcontent", action="store_true", help="Perform the GC content analysis")
    parser.add_argument("--motifs", action="store_true", help="Find AGGGG ATGCT motifs in the sequence")
    
    args = parser.parse_args()
    
    analyze_sequence(args.file, find_duplicates=args.duplicates, find_gc=args.GCcontent, 
                     find_motifs=args.motifs)
